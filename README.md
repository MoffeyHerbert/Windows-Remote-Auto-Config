...
├─LICENSE.txt
├─README.md
├─计算机远程配置 v1.7-ANSI.bat
├─计算机远程配置 v1.7-UTF8.bat
├─计算机远程配置 v1.7[自解压版].exe
├─picture
│    ├─2024-06-22_124606.png
│    └─图标.png
├─system
│  ├─Microsoft_output.reg
│  └─windows_xp_ghost.reg
│  └─GroupPolicy
│      └─GPT.INI
│      ├─Machine
│      │  ├─comment.cmtx
...
### 3.  Microsoft_output.reg
从远程功能正常的 `Windows 10` 系统计算机中导出的组策略配置文件。

### 4.  windows_xp_ghost.reg
从远程功能正常的 `Windows XP` 系统计算机中导出的组策略配置文件。

### 5.  GroupPolicy
从远程功能正常的 `Windows 10` 系统计算机中导出的系统文件。

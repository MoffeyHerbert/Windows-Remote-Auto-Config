...
:: 2.1 打开注册表，找到 HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Enum\Root\RDPDR ，在RDPDR上点击右键，选择“权限”，改变“everyone”的权限为“完全控制”
...
:: 3. 启动服务："Remote Desktop Help Session Manager" 和 "Telnet"
:: 3.1 设置服务启动类型为“自动”
